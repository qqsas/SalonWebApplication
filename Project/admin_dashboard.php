...
<div class="main-content">
    ...
    switch($view) {
        case 'users':
            ...
            echo '<a href="add_user.php?view=users&search='.$searchParam.'" class="add-btn">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <form method='POST' action='update_user_role.php' class='inline-form'>
                ...
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=User&id=".escape($row['UserID'])."&view=users&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_user.php?UserID=".escape($row['UserID'])."&view=users&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=User&id=".escape($row['UserID'])."&view=users&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'barbers':
            ...
            echo '<a href="add_barber.php?view=barbers&search='.$searchParam.'" class="add-btn">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Barber&id=".escape($row['BarberID'])."&view=barbers&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_barber.php?id=".escape($row['BarberID'])."&view=barbers&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=Barber&id=".escape($row['BarberID'])."&view=barbers&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'appointments':
            ...
            echo '<a href="add_appointment.php?view=appointments&search='.$searchParam.'" class="add-btn">
            ...
            echo "<table class='data-table'>
                    <tr>
                        <th>ID</th><th>User</th><th>Barber</th><th>ForName</th><th>ForAge</th><th>Type</th><th>Time</th><th>Duration</th><th>Status</th><th>Cost</th><th>Status</th><th>Actions</th>
                    </tr>";
            while ($row = $result->fetch_assoc()) {
                $statusClass = $row['IsDeleted'] ? 'status-deleted' : 'status-active';
                $statusText = $row['IsDeleted'] ? "Deleted" : "Active";
                echo "<tr>
                        ...
                        <td>
                            <form method='POST' action='update_appointment_status.php' class='inline-form'>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Appointment&id=".escape($row['AppointmentID'])."&view=appointments&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_appointment.php?id=".escape($row['AppointmentID'])."&view=appointments&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=Appointment&id=".escape($row['AppointmentID'])."&view=appointments&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'products':
            ...
            echo "<table class='data-table'>
                    <tr>
                        <th>ID</th><th>Name</th><th>Price</th><th>Category</th><th>Stock</th><th>Status</th><th>Actions</th>
                    </tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Products&id=".escape($row['ProductID'])."&view=products&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_product.php?id=".escape($row['ProductID'])."&view=products&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=Products&id=".escape($row['ProductID'])."&view=products&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'services':
            ...
            echo '<a href="add_service.php?view=services&search='.$searchParam.'" class="add-btn">
            ...
            echo "<table class='data-table'>
                    <tr>
                        <th>ID</th><th>Name</th><th>Description</th><th>Price</th><th>Time</th><th>Status</th><th>Actions</th>
                    </tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Services&id=".escape($row['ServicesID'])."&view=services&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_service.php?id=".escape($row['ServicesID'])."&view=services&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=Services&id=".escape($row['ServicesID'])."&view=services&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'orders':
            ...
            echo '<a href="add_order.php?view=orders&search='.$searchParam.'" class="add-btn">
                    <span>+</span> Add Order
                  </a>';
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Orders&id=".escape($row['OrderID'])."&view=orders&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='edit_order.php?id=".escape($row['OrderID'])."&view=orders&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>";
                    echo "<a href='soft_delete.php?table=Orders&id=".escape($row['OrderID'])."&view=orders&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
        ...
        case 'reviews':
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <form method='POST' action='update_review_status.php' class='inline-form'>
                        ...
                        <td>
                            <div class='action-buttons'>
                                <a href='edit_review.php?id=".escape($row['ReviewID'])."&view=reviews&search=$searchParam&page=$page' class='btn btn-sm btn-primary'>Edit</a>
                                <a href='soft_delete.php?table=Reviews&id=".escape($row['ReviewID'])."&view=reviews&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>
                            </div>
                        </td>
                      </tr>";
            }
        ...
        case 'contacts':
            ...
            echo "<table class='data-table'>
                    <tr>
                        <th>ID</th><th>User</th><th>Message</th><th>ContactInfo</th><th>CreatedAt</th><th>Status</th><th>Actions</th>
                    </tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <div class='action-buttons'>";
                if ($row['IsDeleted']) {
                    echo "<a href='restore.php?table=Contact&id=".escape($row['ContactID'])."&view=contacts&search=$searchParam&page=$page' class='btn btn-sm restore-btn'>Restore</a>";
                } else {
                    echo "<a href='{$contactLink}' class='btn btn-sm btn-primary'>Contact</a>";
                    echo "<a href='soft_delete.php?table=Contact&id=".escape($row['ContactID'])."&view=contacts&search=$searchParam&page=$page' onclick='return confirm(\"Are you sure?\")' class='btn btn-sm btn-danger'>Delete</a>";
                }
                echo "  </div>
                        </td>
                    </tr>";
